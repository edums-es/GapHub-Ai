...
MCP_CATALOG = [
    {
        ...
        "tools": [
            ...
            {"name": "enviar_mensagem_direta", "description": "Envia mensagem como usuário logado (sem créditos) — USE SOMENTE quando explicitamente pedido para contatar o lead"},
            {"name": "enviar_nota_interna", "description": "Adiciona nota interna no ticket — INVISÍVEL para o lead, use para análises, qualificações e observações internas"},
